...
" . $script;
    ...
    /**
     * Generates timestamp part of generated class headers.
     *
     * @return string
     */
    protected function generateTimestampBlock(): string
    {
        ...
        $now = gmdate('c');
        $version = var_export($this->getBuildProperty('general.version', true), true);

        return "
 * This class was autogenerated by Perpl $version on:
 *
 * $now";
    }
}
